...
export default function Home() {
  return (
    <main classNameName="bg-primary text-white">
      <section classNameName="min-h-screen px-4 md:px-20 lg:px-8">
        <nav classNameName="py-10 mb-12 flex justify-between content-center">
          <h1 classNameName="w-1/4 text-xl">
            Francisco Zuniga
          </h1>
          <ul classNameName="flex gap-8">
            <li><a classNameName="" href="#">Competencies</a></li>
            <li><a classNameName="" href="#">Work</a></li>
            <li><a classNameName="" href="#">Experience</a></li>
            <li><a classNameName="" href="#">Contact Me</a></li>
          </ul>
            <BsFillMoonStarsFill classNameName="w-1/4 cursor-pointer text-2xl"/>
        </nav>

        {/* TEST HERO */}

        <div className="h-screen flex items-end">
	<image src="" className="w-full bg-cover bg-center py-32">
		<div className="container mx-auto text-center content-end text-black">
    <h2 classNameName="text-5xl py-2 font-medium md:text-6xl">Francisco Zuniga</h2>
        <h3 classNameName="text-2xl py-2 md:text-4xl">Full-Stack Developer</h3>
        <p classNameName="text-md py-5 leading-8 md:text-xl">Professional Summary Here</p>
		</div>
	</image>
</div>
  ...
  <h2 className="block antialiased tracking-normal text-4xl text-center leading-1 text-blue-gray-900 !text-3xl !leading-snug lg:!text-4xl">My Competencies</h2>
  <div className="flex justify-center mt-10 grid gap-2 lg:grid-cols-4">
    <div className="relative flex flex-col bg-clip-border rounded-xl shadow-md relative grid max-w-sm lg:h-64 items-end overflow-hidden">
      ...
      <div className="p-6 relative flex flex-col justify-end hover:-translate-y-3 duration-300">
        <h4 className="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-white">Full-Stack Development</h4>
        <p className="block antialiased font-sans text-base font-light leading-relaxed text-white my-2 font-normal">Expert in full-stack development, building industry-grade projects with diverse programming languages and frameworks</p>
      </div>
    </div>
    <div className="relative flex flex-col bg-clip-border rounded-xl shadow-md relative grid max-w-sm lg:h-64 items-end overflow-hidden">
      <div className="bg-gradient-to-br from-[#4ade80] to-[#3b82f6] absolute inset-0"></div>
      <div className="p-6 relative flex flex-col justify-end hover:-translate-y-3 duration-300">
        <h4 className="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-white">Problem-Solving and Analytical Skills</h4>
        <p className="block antialiased font-sans text-base font-light leading-relaxed text-white my-2 font-normal">Skilled in solving complex problems and detailed analysis, contributing significantly in software and financial roles</p>
      </div>
    </div>
    <div className="relative flex flex-col bg-clip-border rounded-xl shadow-md relative grid max-w-sm lg:h-64 items-end overflow-hidden">
      <div className="bg-gradient-to-br from-[#f869d5] to-[#5650de] absolute inset-0"></div>
      <div className="p-6 relative flex flex-col justify-end hover:-translate-y-3 duration-300">
        <h4 className="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-white">Project Management and Agile Methodology</h4>
        <p className="block antialiased font-sans text-base font-light leading-relaxed text-white my-2 font-normal">Proficient in agile project management, successfully planning and executing numerous reports and applications</p>
      </div>
    </div>
    <div className="relative flex flex-col bg-clip-border rounded-xl shadow-md relative grid max-w-sm lg:h-64 items-end overflow-hidden">
      <div className="bg-gradient-to-br from-[#f00b51] to-[#7366ff] absolute inset-0"></div>
      <div className="p-6 relative flex flex-col justify-end hover:-translate-y-3 duration-300">
        <h4 className="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-white">Communication and Mentorship</h4>
        <p className="block antialiased font-sans text-base font-light leading-relaxed text-white my-2 font-normal">Effective communicator and mentor, highly rated for work ethic and delivering clear, comprehensive briefs and reports</p>
      </div>
    </div>
  </div>
</section>
  ...
  <h2 className="block antialiased tracking-normal text-4xl text-center leading-1 text-blue-gray-900 !text-3xl !leading-snug lg:!text-4xl">My Work</h2>
        ...
        <div className="mt-4 grid grid-cols-2">
          <div className="flex items-center">
            <div className="relative">
              <h2 className="line-clamp-1 text-base font-medium text-white md:text-lg">Statue of Liberty</h2>
              <p className="mt-2 line-clamp-1 text-sm text-white">Web Development</p>
            </div>
          </div>
        </div>
      </div>
...
<div className="relative mx-auto w-full max-w-sm pt-6 drop-shadow-lg">
  ...
  <h2 className="block antialiased tracking-normal text-4xl text-center leading-1 text-blue-gray-900 !text-3xl !leading-snug lg:!text-4xl">Professional Experience</h2>
  <div className="relative min-h-1/2 flex flex-col bg-accent overflow-hidden antialiased">
    <div className="m-auto w-full max-w-6xl mx-auto px-4 md:px-6 py-8">
                    ...
                    <div className="relative">
                        <div className="md:flex items-center md:space-x-4 mb-3">
                            <div className="flex items-center space-x-4 md:space-x-2 md:space-x-reverse">
                                ...
                                {/* <!-- Date --> */}
                                <time className="text-sm font-medium text-indigo-500 md:w-28">Apr 7, 2024 - Apr 7, 2024</time>
                            </div>
                            {/* <!-- Title --> */}
                            <div className="text-slate-500 ml-14"><span className="text-slate-900 font-bold">ProSource Wholesale</span> Account Expeditor</div>
                        </div>
                        {/* <!-- Card --> */}
...
{/* RESUME 2 */}
      ...
      {/* FOOTER */}
        <section>
<footer className="w-full text-gray-700 bg-secondary body-font">
    <div className="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
        <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
            ...
            <p classNameName="mt-2 text-sm text-gray-500">Design, Code and Ship!</p>
            <div className="mt-4">
                <span className="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                    ...
                    <a className="ml-3 text-red-500 cursor-pointer hover:text-gray-700">
                        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            className="w-5 h-5" viewBox="0 0 24 24">
                            <path
