...
export default function Home() {
  ...
  useEffect(() => {
    ...
    }, 15000); // Change message every 3 seconds
  ...
  return (
    <main className="bg-primary text-[#fff]">
      ...
      {/* FOOTER */}
      <section>
        <footer className="w-full bg-secondary body-font h-64 grid grid-cols-4 flex">
          <div className="container flex flex-col flex-wrap items-start pl-12 pt-8 col-span-3">
